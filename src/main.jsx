...
function App() {
  return <>
    ...
    <Section id="cv" kicker="CV" title="CV et documents">
      <div className="cv-card"><div><h3>Abderrahmane_Mejdoubi_CV.pdf</h3><p>Place ton fichier dans <code>public/CV/Abderrahmane_Mejdoubi_CV.pdf</code> pour activer le bouton.</p></div><a className="btn primary" href={profile.cvPath} download><Download size={18}/> Télécharger</a></div>
    </Section>
